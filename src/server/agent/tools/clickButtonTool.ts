...
import { resolveButtonTabChunkLocation } from "../pageRead/index.ts";
...
type ClickButtonArgs = { id: string };
...
const parameters = {
  ...
  execute = async (
    ...
    const message: ClickButtonRequest = { id, type: "clickButton" };
