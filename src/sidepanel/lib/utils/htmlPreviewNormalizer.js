...
const CDN_BASE_URL = "https://esm.sh/",
  ...
  toCdnUrl = (specifier) => `${CDN_BASE_URL}${specifier}`,
  ...
  collectBareSpecifiers = (code, specifiers) => {
  ...
  insertImportMapScript = (doc, script) => {
  ...
  updateImportMap = (doc, specifiers) => {
    ...
    const scripts = Array.from(doc.querySelectorAll("script")),
      importMapScripts = scripts.filter((script) => {
